...
function resolver_y_guardar(divisions_x::Int, divisions_y::Int,N::Int, cols, filas, 
...
Turbinas_solucion=resolver_y_guardar(
    divisions_x, divisions_y,N, cols, filas, 
...
Turbinas_solucion_matrix=Dict()
Energia_iter=Dict()
Turbinas_solucion_matrix[1]=Turbinas_solucion
Energia_iter[1]=Energia


for i in 2:50
    Turbinas_solucion_matrix[i],Energia_iter[i]=iteraciones(Turbinas_solucion_matrix[i-1],Poligono,J2,K,R2,N,x_step,y_step,cols,filas,x_val1,y_val1,E2,i)
end
